#include "IOC_TypeEvtID.h"
#include "IOC_TypeMsgDesc.h"
#include "IOC_Types.h"
...
static inline ULONG_T IOC_EvtDesc_getSeqID(IOC_EvtDesc_pT pEvtDesc) {
  return pEvtDesc->MsgDesc.SeqID;
}
static inline IOC_EvtID_T IOC_EvtDesc_getEvtID(IOC_EvtDesc_pT pEvtDesc) { return pEvtDesc->EvtID; }
static inline ULONG_T IOC_EvtDesc_getEvtValue(IOC_EvtDesc_pT pEvtDesc) {
  return pEvtDesc->EvtValue;
}
...
static inline const char *IOC_EvtDesc_getEvtFullNameStr(IOC_EvtDesc_pT pEvtDesc,
                                                        char *EvtFullNameBuf,
