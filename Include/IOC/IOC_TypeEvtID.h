...
typedef enum {
  ...
  IOC_EVT_NAME_TEST_SLEEP_999MS            = 1 << 5ULL,
  IOC_EVT_NAME_TEST_KEEPALIVE_RELAY        = 1 << 6ULL,
...
#define IOC_EVTID_TEST_KEEPALIVE_RELAY \
  IOC_defineEvtID(IOC_EVT_CLASS_TEST, IOC_EVT_NAME_TEST_KEEPALIVE_RELAY)
...
#define IOC_EVTID_TEST_SLEEP_999MS \
  IOC_defineEvtID(IOC_EVT_CLASS_TEST, IOC_EVT_NAME_TEST_SLEEP_999MS)
